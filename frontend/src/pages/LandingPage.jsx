    ...
    <div className="min-h-screen bg-dark relative overflow-hidden selection:bg-cyan/30">
      ...
      <section className="relative z-10 pt-32 md:pt-48 pb-20 md:pb-32 px-4 md:px-6 flex flex-col items-center justify-center min-h-screen">
        ...
        >
          ...
          >
            Deploying <span className="text-white font-bold">neural pathfinding</span> to secure global supply chains.
            Automate disruption recovery with sub-millisecond precision.
          </motion.p>
          ...
          >
            <Link to="/dashboard" className="btn-neon w-full sm:w-auto px-10 md:px-20 py-6 md:py-8 text-xs md:text-sm group flex items-center justify-center gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            >
               <div className="flex-1 text-center md:text-left">
                  ...
                  <h3 className="text-3xl md:text-4xl font-black mb-4 md:mb-6 uppercase tracking-tighter">Ironclad Encryption</h3>
                  <p className="text-slate-400 text-sm md:text-lg leading-relaxed">
                    Military-grade end-to-end encryption for every logistical signal. Your network data is locked behind AES-256 tactical protocols.
                  </p>
                  <div className="mt-8 flex justify-center md:justify-start gap-3">
                     <span className="w-8 h-1 bg-cyan" />
                     <span className="w-8 h-1 bg-cyan/50" />
                     <span className="w-8 h-1 bg-cyan/20" />
                  </div>
               </div>
      ...
      <section className="py-24 md:py-64 px-4 md:px-6 text-center relative z-10 overflow-hidden">
         ...
         >
           ...
           <div className="flex justify-center px-4">
             <Link to="/dashboard" className="btn-neon w-full sm:w-auto px-8 md:px-24 py-6 md:py-10 text-sm md:text-lg font-black tracking-[0.2em] md:tracking-[0.6em] group relative overflow-hidden flex items-center justify-center">
